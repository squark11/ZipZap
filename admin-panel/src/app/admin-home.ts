...
@Component({
  ...
  @if (stats) {
    <div class="sgrid">
      <div class="stat hero">
        ...
        <div class="sval"><b>{{ stats.orders.gmv | number:'1.2-2' }} zł</b><span>GMV (bez anulowanych)</span></div>
      </div>
      <div class="stat">
      ...
      <div class="stat" [class.warn]="stats.pendingDrivers > 0">
      ...
      <div class="stat" [class.warn]="stats.users.inactive > 0">
  ...
  styles: [`
    ...
    .stat { display:flex; align-items:center; gap:14px; background:#fff; border:1px solid #E5E7EB; border-radius:14px; padding:18px; }
